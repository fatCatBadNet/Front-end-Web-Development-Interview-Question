...
(function ($, window, document, name) {
    ...
    var OffCanvas = $.Class.extend({
        ...
        refresh: function (offCanvas) {
            ...
            console.log(this.offCanvasRight);
            if (this.offCanvasRight) {
                console.log("this.offCanvasRight");
                console.log(this.offCanvasRight.offsetWidth);
                //console.log(this.offCanvasRight.length);
                console.log("this.offCanvasRight");
        ...
        show: function (direction) {
            ...
            console.log(this.offCanvasRight.offsetWidth === this.offCanvasRightWidth);
            console.log(this.offCanvasRightWidth, 'showright');
            if (direction === 'right') {
                this.offCanvas = this.offCanvasRight;
                this.offCanvasWidth = this.offCanvasRightWidth;
            } else {
        ...
        toggle: function (directionOrOffCanvas) {
            ...
            console.log(this.offCanvasWidth, 'togglle');
